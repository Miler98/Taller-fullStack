$(document).ready(function()
{
    ...
    $(document).on('click','.btn-danger',function()
    {
        ...
        {
            $('<form action="/estudiantes/' + $(this).val() + '" method="POST"><input type="hidden" name="_method" value="DELETE"/><input //type="hidden" name="_token" value="' + token + '"/></form').appendTo('body').submit();
        }  
    });
});